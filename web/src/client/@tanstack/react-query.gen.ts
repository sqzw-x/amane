 ...
 */
export const listPlaybackSourcesOptions = (options: Options<ListPlaybackSourcesData>) => queryOptions<ListPlaybackSourcesResponse, ListPlaybackSourcesError, ListPlaybackSourcesResponse, ReturnType<typeof listPlaybackSourcesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const playFilePlaylistQueryKey = (options: Options<PlayFilePlaylistData>) => createQueryKey('playFilePlaylist', options);

/**
 * Play File Playlist
 */
export const playFilePlaylistOptions = (options: Options<PlayFilePlaylistData>) => queryOptions<unknown, PlayFilePlaylistError, unknown, ReturnType<typeof playFilePlaylistQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await playFilePlaylist({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: playFilePlaylistQueryKey(options)
});
...
export const playFileHlsPartQueryKey = (options: Options<PlayFileHlsPartData>) => createQueryKey('playFileHlsPart', options);

/**
 * Play File Hls Part
 */
export const playFileHlsPartOptions = (options: Options<PlayFileHlsPartData>) => queryOptions<unknown, PlayFileHlsPartError, unknown, ReturnType<typeof playFileHlsPartQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await playFileHlsPart({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: playFileHlsPartQueryKey(options)
});
...
export const playFileSubtitleQueryKey = (options: Options<PlayFileSubtitleData>) => createQueryKey('playFileSubtitle', options);

/**
 * Play File Subtitle
 */
export const playFileSubtitleOptions = (options: Options<PlayFileSubtitleData>) => queryOptions<unknown, PlayFileSubtitleError, unknown, ReturnType<typeof playFileSubtitleQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await playFileSubtitle({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: playFileSubtitleQueryKey(options)
});
...
export const playMetadataFileQueryKey = (options: Options<PlayMetadataFileData>) => createQueryKey('playMetadataFile', options);

/**
 * Play Metadata File
 */
export const playMetadataFileOptions = (options: Options<PlayMetadataFileData>) => queryOptions<unknown, PlayMetadataFileError, unknown, ReturnType<typeof playMetadataFileQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await playMetadataFile({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: playMetadataFileQueryKey(options)
});
