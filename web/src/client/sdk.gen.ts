 ...
 */
export const listPlaybackSources = <ThrowOnError extends boolean = false>(options: Options<ListPlaybackSourcesData, ThrowOnError>): RequestResult<ListPlaybackSourcesResponses, ListPlaybackSourcesErrors, ThrowOnError> => (options.client ?? client).get<ListPlaybackSourcesResponses, ListPlaybackSourcesErrors, ThrowOnError>({ url: '/api/playback/sources', ...options });
 ...
 * Play File Playlist
 */
export const playFilePlaylist = <ThrowOnError extends boolean = false>(options: Options<PlayFilePlaylistData, ThrowOnError>): RequestResult<PlayFilePlaylistResponses, PlayFilePlaylistErrors, ThrowOnError> => (options.client ?? client).get<PlayFilePlaylistResponses, PlayFilePlaylistErrors, ThrowOnError>({ url: '/api/playback/{source_id}/{metadata_id}/files/{media_file_id}/index.m3u8', ...options });
 ...
 * Play File Hls Part
 */
export const playFileHlsPart = <ThrowOnError extends boolean = false>(options: Options<PlayFileHlsPartData, ThrowOnError>): RequestResult<PlayFileHlsPartResponses, PlayFileHlsPartErrors, ThrowOnError> => (options.client ?? client).get<PlayFileHlsPartResponses, PlayFileHlsPartErrors, ThrowOnError>({ url: '/api/playback/{source_id}/{metadata_id}/files/{media_file_id}/hls/{token}', ...options });
 ...
 * Play File Subtitle
 */
export const playFileSubtitle = <ThrowOnError extends boolean = false>(options: Options<PlayFileSubtitleData, ThrowOnError>): RequestResult<PlayFileSubtitleResponses, PlayFileSubtitleErrors, ThrowOnError> => (options.client ?? client).get<PlayFileSubtitleResponses, PlayFileSubtitleErrors, ThrowOnError>({ url: '/api/playback/{source_id}/{metadata_id}/files/{media_file_id}/subtitles/{track_id}', ...options });
 ...
 * Play Metadata File
 */
export const playMetadataFile = <ThrowOnError extends boolean = false>(options: Options<PlayMetadataFileData, ThrowOnError>): RequestResult<PlayMetadataFileResponses, PlayMetadataFileErrors, ThrowOnError> => (options.client ?? client).get<PlayMetadataFileResponses, PlayMetadataFileErrors, ThrowOnError>({ url: '/api/playback/{source_id}/{metadata_id}/files/{media_file_id}', ...options });
