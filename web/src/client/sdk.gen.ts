 ...
 */
export const checkConnectivity = <ThrowOnError extends boolean = false>(options?: Options<CheckConnectivityData, ThrowOnError>): RequestResult<CheckConnectivityResponses, CheckConnectivityErrors, ThrowOnError> => (options?.client ?? client).post<CheckConnectivityResponses, CheckConnectivityErrors, ThrowOnError>({
 ...
 */
export const batchActorUserTags = <ThrowOnError extends boolean = false>(options: Options<BatchActorUserTagsData, ThrowOnError>): RequestResult<BatchActorUserTagsResponses, BatchActorUserTagsErrors, ThrowOnError> => (options.client ?? client).post<BatchActorUserTagsResponses, BatchActorUserTagsErrors, ThrowOnError>({
